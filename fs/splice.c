...
#endif /* defined(CONFIG_AMP_ALL) || defined(CONFIG_AMP_PURENAS) */
...
#ifdef CONFIG_AMP
EXPORT_SYMBOL(wakeup_pipe_writers);
#endif
 ...
 */
#if defined(CONFIG_AMP)
int ipipe_prep(struct pipe_inode_info *pipe, unsigned int flags)
#else
 ...
 */
#if defined(CONFIG_AMP)
int opipe_prep(struct pipe_inode_info *pipe, unsigned int flags)
#else
