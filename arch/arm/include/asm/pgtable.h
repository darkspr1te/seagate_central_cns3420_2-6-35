...
#define PAGE_SHARED_EXEC	\
		_MOD_PROT(pgprot_user, L_PTE_USER | L_PTE_WRITE | L_PTE_EXEC)
...
#define __PAGE_SHARED		\
		__pgprot(_L_PTE_DEFAULT | L_PTE_USER | L_PTE_WRITE)
#define __PAGE_SHARED_EXEC	\
		__pgprot(_L_PTE_DEFAULT | L_PTE_USER | L_PTE_WRITE | L_PTE_EXEC)
#define __PAGE_COPY		__pgprot(_L_PTE_DEFAULT | L_PTE_USER)
#define __PAGE_COPY_EXEC	\
		__pgprot(_L_PTE_DEFAULT | L_PTE_USER | L_PTE_EXEC)
...
#define pte_offset_map(dir, addr)	(__pte_map(dir, KM_PTE0) + \
					 __pte_index(addr) * PTE_STEP)
#define pte_offset_map_nested(dir, addr)	(__pte_map(dir, KM_PTE1) + \
					 __pte_index(addr) * PTE_STEP)
#else /* CONFIG_PAGE_SIZE_64K */
#define pte_offset_kernel(dir, addr)		\
	(pmd_page_vaddr(*(dir)) + __pte_index(addr))

#define pte_offset_map(dir, addr)		\
		(__pte_map(dir, KM_PTE0) + __pte_index(addr))
#define pte_offset_map_nested(dir, addr)	\
		(__pte_map(dir, KM_PTE1) + __pte_index(addr))
...
#else
#define __pte_map(dir, km)	\
	((pte_t *)kmap_atomic(pmd_page(*(dir)), km) + PTRS_PER_PTE)
