...
#define	QUEUE_DEPTH_ALIGN_MUL		0x10	/* 16 bytes; ALIGNMENT ==
						   QDEPTH * 16 bytes */
...
#define	CURR_Q_DEPTH_ALIGN		\
				((CURR_Q_DEPTH) * (QUEUE_DEPTH_ALIGN_MUL))
				/* 0x200 */
...
extern mempool_t	*rdma_sg_pool;
extern rdma_chan_t	*dma;
extern unsigned int	dma_timeout_jiffies;
void rdma_unit_test(int, unsigned int, unsigned int);

extern int		rdma_verbose;
extern u8		rdma_test_ptn[32];
extern rdma_chan_t	*dma;			/* dma channel */
extern int		rdma_irq_enabled;
