...
printk("%s=>%d\n", __FUNCTION__, __LINE__);
	...
	reg = wm8580_read(codec, WM8580_PWRDN2);
	wm8580_write(codec, WM8580_PWRDN2, reg & ~pwr_mask);
	printk("%s=>%d WM8580_PWRDN2: 0x%08x\n", __FUNCTION__, __LINE__, reg);
	printk("%s=>%d pwr_mask: 0x%08x\n", __FUNCTION__, __LINE__, pwr_mask);
...
printk("%s=>%d\n", __FUNCTION__, __LINE__);
	...
	reg = wm8580_read_reg_cache(codec, WM8580_PWRDN2);
	if (mute) {
		reg |= (WM8580_PWRDN2_SPDIFTXD);
	}
	else {
		reg &= ~(WM8580_PWRDN2_SPDIFTXD);
	}
	wm8580_write(codec, WM8580_PWRDN2, reg);

//	reg = wm8580_read_reg_cache(codec, WM8580_PWRDN2);
//	printk("%s=>%d WM8580_PWRDN2: 0x%08x\n", __FUNCTION__, __LINE__, reg);
//	reg = wm8580_read_reg_cache(codec, WM8580_SPDTXCHAN0);
//	printk("%s=>%d WM8580_SPDTXCHAN0: 0x%08x\n", __FUNCTION__, __LINE__, reg);
//	reg = wm8580_read_reg_cache(codec, WM8580_SPDTXCHAN1);
//	printk("%s=>%d WM8580_SPDTXCHAN1: 0x%08x\n", __FUNCTION__, __LINE__, reg);
//	reg = wm8580_read_reg_cache(codec, WM8580_SPDTXCHAN2);
//	printk("%s=>%d WM8580_SPDTXCHAN2: 0x%08x\n", __FUNCTION__, __LINE__, reg);
//	reg = wm8580_read_reg_cache(codec, WM8580_SPDTXCHAN3);
//	printk("%s=>%d WM8580_SPDTXCHAN3: 0x%08x\n", __FUNCTION__, __LINE__, reg);
//	reg = wm8580_read_reg_cache(codec, WM8580_SPDTXCHAN4);
//	printk("%s=>%d WM8580_SPDTXCHAN4: 0x%08x\n", __FUNCTION__, __LINE__, reg);
//	reg = wm8580_read_reg_cache(codec, WM8580_SPDTXCHAN5);
//	printk("%s=>%d WM8580_SPDTXCHAN5: 0x%08x\n", __FUNCTION__, __LINE__, reg);
//	reg = wm8580_read_reg_cache(codec, WM8580_CLKSEL);
//	printk("%s=>%d WM8580_CLKSEL: 0x%08x\n", __FUNCTION__, __LINE__, reg);
...
printk("%s=>%d\n", __FUNCTION__, __LINE__);
	...
	wm8580_write(codec, WM8580_SPDTXCHAN0, 0x3);
	wm8580_write(codec, WM8580_SPDTXCHAN1, 0x4);
	wm8580_write(codec, WM8580_SPDTXCHAN2, 0x0);
	wm8580_write(codec, WM8580_SPDTXCHAN3, 0x0);
	wm8580_write(codec, WM8580_SPDTXCHAN4, 0x31);
	wm8580_write(codec, WM8580_SPDTXCHAN5, 0xb);
	val = wm8580_read_reg_cache(codec, WM8580_PWRDN2);
	val &= ~(WM8580_PWRDN2_SPDIFTXD);
	wm8580_write(codec, WM8580_PWRDN2, val);
	
	val = wm8580_read_reg_cache(codec, WM8580_CLKSEL);
	wm8580_write(codec, WM8580_CLKSEL, val | (0x3 << 4));
