...
/* CNS3XXX OTG controller */
#ifdef CONFIG_USB_GADGET_CNS3XXX
#define gadget_is_cns3xxx(g)	(!strcmp("dwc_otg_pcd", (g)->name))
#else
#define gadget_is_cns3xxx(g)	0
#endif
...
static inline int usb_gadget_controller_number(struct usb_gadget *gadget)
{
	if (gadget_is_net2280(gadget))
		...
		return 0x26;
	else if (gadget_is_cns3xxx(gadget))
		return 0x27;
	return -ENOENT;
}
