...
#define INIT_PORT0_PHY probe_phy(0, 3);
#define INIT_PORT1_PHY 
#define INIT_PORT2_PHY cns3xxx_phy_auto_polling_conf_ex(2, 0, 0);
...
#define PORT0_LINK_DOWN cns3xxx_std_phy_power_down(3, 1);
#define PORT0_LINK_UP cns3xxx_std_phy_power_down(3, 0);
