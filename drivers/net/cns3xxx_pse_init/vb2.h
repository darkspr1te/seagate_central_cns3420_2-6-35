...
static int rc_port0; /* Port0 reference counter, determine port open / close. */
...
/*
 * Only one of following macro can be defined.
 * CNS3XXX_NIC_MODE_8021Q
 * CNS3XXX_NON_NIC_MODE_8021Q
 * CNS3XXX_VLAN_BASE_MODE
 * CNS3XXX_PORT_BASE_MODE
 */
...
VLANTableEntry cpu_vlan_table_entry = {
	0, 1, CPU_PVID, 0, 0,
...
NetDevicePriv net_device_prive[] = {
	...
	{MAC_PORT0_PMAP, 0, 1, PORT0_NETDEV_INDEX, rx_port_base, tx_port_base,
		open_port0, close_port0, MAC_PORT0, my_vlan0_mac,
		&vlan_table_entry[0], &arl_table_entry[0], 0, 0},   /* eth0 */
	{MAC_PORT1_PMAP, 0, 2, PORT1_NETDEV_INDEX, rx_port_base, tx_port_base,
		open_port1, close_port1, MAC_PORT1, my_vlan1_mac,
		&vlan_table_entry[1], &arl_table_entry[1], 0, 0},   /* eth1 */
	{MAC_PORT2_PMAP, 1, 3, PORT2_NETDEV_INDEX, rx_port_base, tx_port_base,
		open_port2, close_port2, MAC_PORT2, my_vlan2_mac,
		&vlan_table_entry[2], &arl_table_entry[2], 0, 0},   /* eth2 */
#if defined(CONFIG_CNS3XXX_SPPE)
	{CPU_PORT_PMAP, 0, 1, FP_NETDEV_INDEX, NULL, fp_port_base,
		open_fp, close_fp, CPU_PORT, my_vlan3_mac,
		&cpu_vlan_table_entry, 0, 0, "fp"}
#endif
};
...
VLANTableEntry vlan_table_entry[] = {
	...
	/* For CPU
	{2, 1, 4, 0, 0, MAC_PORT0_PMAP | MAC_PORT1_PMAP | MAC_PORT2_PMAP | CPU_PORT_PMAP, my_vlan3_mac},
	 */
};
...
NetDevicePriv net_device_prive[] = {
	{MAC_PORT0_PMAP, 0, 1, PORT0_NETDEV_INDEX, rx_port_base, tx_port_base,
		open_port0, close_port0, MAC_PORT0, my_vlan0_mac,
		&vlan_table_entry[0], &arl_table_entry[0], 0, 0},   /* eth0 */
	{MAC_PORT1_PMAP, 0, 0, PORT1_NETDEV_INDEX, rx_port_base, tx_port_base,
		open_port1, close_port1, MAC_PORT1, my_vlan1_mac,
		&vlan_table_entry[1], &arl_table_entry[1], 0, 0},   /* eth1 */
	{MAC_PORT2_PMAP, 1, 3, PORT2_NETDEV_INDEX, rx_port_base, tx_port_base,
		open_port2, close_port2, MAC_PORT2, my_vlan2_mac,
...
NetDevicePriv net_device_prive[] = {
	{MAC_PORT0_PMAP, 0, 1, PORT0_PVID, rx_port_base, tx_vlan_base,
		open_port0, close_port0, MAC_PORT0, my_vlan0_mac,
		&vlan_table_entry[0], &arl_table_entry[0], 0, 0},   /* eth0 */
	{MAC_PORT1_PMAP, 0, 0, PORT1_PVID, rx_port_base, tx_vlan_base,
		open_port1, close_port1, MAC_PORT1, my_vlan1_mac,
		&vlan_table_entry[1], &arl_table_entry[1], 0, 0},   /* eth1 */
	{MAC_PORT2_PMAP, 1, 3, PORT2_PVID, rx_port_base, tx_vlan_base,
		open_port2, close_port2, MAC_PORT2, my_vlan2_mac,
		&vlan_table_entry[2], &arl_table_entry[2], 0, 0}    /* eth2 */
};
...
int num_net_dev_priv = ARRAY_SIZE(net_device_prive);
