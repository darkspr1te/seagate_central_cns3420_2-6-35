...
#ifndef RTL8367_ONE_LEG_H
#define RTL8367_ONE_LEG_H
...
#define INIT_PORT1_MAC 									//cypress 110324
//#define INIT_PORT1_MAC rtl8367_init_mac(1);			//cypress 110324
#define INIT_PORT2_MAC 

#define PORT0_LINK_DOWN disable_AN(0, 0);
#define PORT0_LINK_UP disable_AN(0, 1);

#define PORT1_LINK_DOWN 								//cypress 110324
//#define PORT1_LINK_DOWN disable_AN(0, 0);				//cypress 110324
#define PORT1_LINK_UP 									//cypress 110324
//#define PORT1_LINK_UP disable_AN(0, 1);				//cypress 110324

#define PORT2_LINK_DOWN 
#define PORT2_LINK_UP 

#define MODEL "RTL8367 One Leg Board"
